// src/app/page.tsx (or app/page.tsx depending on your structure)

'use client';

import React, { useEffect, useRef, useState, useCallback } from 'react';
import Projects from '../components/Projects'; // Verify this path matches your setup
    ...
    >
      ...
      <section id="contact" className="max-w-4xl mx-auto px-6 py-16 relative z-10 border-t border-white/5 scroll-mt-20 text-center" aria-labelledby="contact-heading">
        ...
        <address className="not-italic flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 text-sm font-medium">
          <a href="mailto:nileshkishore2001@gmail.com" className="flex items-center gap-2 text-slate-300 transition-colors" onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--color-primary-400)')} onMouseLeave={(e) => (e.currentTarget.style.color = currentTheme === 'white' ? '#475569' : '#cbd5e1')}>
          ...
          <a href="tel:+917488602895" className="flex items-center gap-2 text-slate-300 transition-colors" onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--color-secondary-400)')} onMouseLeave={(e) => (e.currentTarget.style.color = currentTheme === 'white' ? '#475569' : '#cbd5e1')}>
          ...
          <a href="https://github.com/Nileshkishore" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-300 transition-colors" onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--color-primary-400)')} onMouseLeave={(e) => (e.currentTarget.style.color = currentTheme === 'white' ? '#475569' : '#cbd5e1')}>
          ...
          <a href="https://www.linkedin.com/in/nilesh-kishore-1b70381b2" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-300 transition-colors" onMouseEnter={(e) => (e.currentTarget.style.color = '#60a5fa')} onMouseLeave={(e) => (e.currentTarget.style.color = currentTheme === 'white' ? '#475569' : '#cbd5e1')}>
